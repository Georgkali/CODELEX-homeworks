...
$weight = (float) readline("Enter weight(kg): ");
$height = (float) readline("Enter height(cm): ");

$bmi = $weight / ($height * $height) * 10000;

if ($bmi < 18.5) {
    echo "Your BMI is " . number_format($bmi, 2) . " you considered underweight";
} elseif ($bmi >= 18.5 && $bmi <= 25) {
     echo "Your BMI is " . number_format($bmi, 2) . " your weight is considered optimal";
} else {
    echo "Your BMI is " . number_format($bmi, 2) . " you considered overweight";
}
